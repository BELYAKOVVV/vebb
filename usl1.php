...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['add_to_cart'])) {
    ...
    $product_name = $usluga_name; // Имя товара
    $product_price = $cost; // Цена товара

    // Добавляем товар в корзину в сессии
    if (!isset($_SESSION['cart'])) {
        $_SESSION['cart'] = array(); // Если корзина пуста, создаем массив
    }
...
<form action="add_to_cart.php" method="POST">
    ...
    <input type="hidden" name="price" value="<?php echo $row_product['cost']; ?>">
