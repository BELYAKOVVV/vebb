...
<header class="header">
    ...
    <div class="header_help">
        ...
        <div class="content">
            ...
            <div class="main">
                <h1 class="des">О нас</h1>
                <div class="text_and_pic">
                    <p> <strong>90</strong>
                        Салонов по всей России<br>
                        <strong>1360</strong>
                        Топовых специалистов<br>
                        <strong>1млн</strong>
                        Счастливых клиентов в год<br>
                    </p>
                    <img src="https://persona.ru/upload/iblock/c83/c8357e37257313656f1698121a1e4c3c.jpg" alt="about">
                </div>
                <p><strong>МИССИЯ ПЕРСОНЫ - ТВОРИТЬ КРАСОТУ ЛЮБОВЬЮ.</strong><br>

                    Мы созидаем притягательную атмосферу сотворчества и раскрываем в ней таланты и уникальность каждого прикоснувшегося, соединяя красоту его внутреннего мира, и мира в котором мы живём.  
                    
                    <br><strong>ОТВЕТСТВЕННО. ОСОЗНАННО. ЧУВСТВЕННО.</strong></p>
                    <h1>Скачайте конфиденциальное соглашение</h1>
        <!-- Кнопка для скачивания соглашения -->
        <a href="download_agreement.php">
            <button>Скачать соглашение</button>
        </a>
            </div>
            <div class="right">
                <form class="search">
